...
def features():
    ...
    for file in os.listdir("/Users/jasminehsu/Downloads/review_polarity/test/pos"):
    ...
    for file in os.listdir("/Users/jasminehsu/Downloads/review_polarity/test/neg"):
        if file.endswith(".txt"):
            sentiment = "neg"
...
features = open("/Users/jasminehsu/Downloads/review_polarity/test/featureList.txt", 'rb')
